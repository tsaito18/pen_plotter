...
def core_options(parser, config):
    ...
    options.add_option("--pen_pos_down",\
                        type="float", action="store", dest="pen_pos_down",\
                        default=config["pen_pos_down"],\
                        help="Height of pen when lowered (0-10)")
    
    options.add_option("--laser_power",\
                        type="float", action="store", dest="laser_power",\
                        default=config["laser_power"],\
                        help="laser_power (0-100)")
    
    options.add_option("--laser_focus_power",\
                        type="float", action="store", dest="laser_focus_power",\
                        default=config["laser_focus_power"],\
                        help="laser_focus_power (0-30)")

    options.add_option("--pen_pos_up",\
                        type="float", action="store", dest="pen_pos_up", \
                        default=config["pen_pos_up"], \
                        help="Height of pen when raised (0-10)")
