...
logger = logging.getLogger('idraw2_0internal.idraw.versions')

# keys used for reporting versions relevant to this repo
DEV_AXIDRAW_CONTROL = "iDraw2 Control (unstable)"
AXIDRAW_CONTROL = "iDraw2 Control"
...
def get_current(plot_status):
    ...
    #     if not min_fw_version(plot_status, "2.13"):
    #         return None, None
