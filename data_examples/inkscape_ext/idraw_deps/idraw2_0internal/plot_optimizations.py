...
path_objects = from_dependency_import('idraw2_0internal.path_objects')
plot_utils = from_dependency_import('drawcore_plotink.plot_utils')
rtree = from_dependency_import('drawcore_plotink.rtree')
spatial_grid = from_dependency_import('drawcore_plotink.spatial_grid')
