...
| カテゴリ | 部品 | 数量 |
|---------|------|------|
| **フレーム** | 2020アルミフレーム 500mm | 4本 |
| | 2020アルミフレーム 400mm | 4本 |
| | L字ブラケット・コーナー金具 | 16個 |
| **駆動系** | NEMA17 ステッピングモーター | 2個 |
| | GT2タイミングベルト 6mm (5m) | 1本 |
| | GT2プーリー 20T (5mm軸) | 2個 |
| | GT2アイドラーベアリング | 6個 |
| **ガイド** | MGN12Hリニアレール 400mm | 2本 (X軸) |
| | MGN12Hリニアレール 300mm | 1本 (Y軸/ガントリー) |
...
#### CAD設計
- **推奨ソフト**: FreeCAD（フレーム設計）、OpenSCAD（パラメトリックなペンホルダー）
- **設計ポイント**:
  - 作業エリア: A4用紙対応（210mm × 297mm以上）
  - ベルトパス: CoreXY標準配置（4コーナーアイドラー＋2モータープーリー）
  - ペンホルダー: ペンの太さ調整可能な構造、サーボによる3-5mm昇降
